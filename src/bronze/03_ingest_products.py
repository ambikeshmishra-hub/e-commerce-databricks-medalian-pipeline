"""Bronze-layer ingestion for the products CSV source."""
...
def ingest_products(
    spark: SparkSession,
    source_path: str = "data/products.csv",
) -> DataFrame:
    ...
    Args:
        ...
        source_path: Path to the products CSV file (relative to project root or absolute).
...
def _build_spark_session() -> SparkSession:
    ...
    return (
        SparkSession.builder.appName("bronze_ingest_products")
        .config(
...
if __name__ == "__main__":
    ...
    bronze_products_df = ingest_products(spark_session)
