"""Bronze-layer ingestion for the orders CSV source."""
...
def ingest_orders(
    spark: SparkSession,
    source_path: str = "data/orders.csv",
) -> DataFrame:
    ...
    Args:
        ...
        source_path: Path to the orders CSV file (relative to project root or absolute).
...
def _build_spark_session() -> SparkSession:
    ...
    return (
        SparkSession.builder.appName("bronze_ingest_orders")
        .config(
...
if __name__ == "__main__":
    ...
    bronze_orders_df = ingest_orders(spark_session)
